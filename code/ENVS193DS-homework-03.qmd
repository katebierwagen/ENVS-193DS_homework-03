...
I believe the authors handled "visual clutter" very well. The figure has minimal amount of gridlines, a white background, and no underlying data which in my opionion was a good decison as it would clutter the figure otherwise. The figure has a high data:ink ratio, the x- axis label is very well displayed, and the legend is clear and displayed well. 
